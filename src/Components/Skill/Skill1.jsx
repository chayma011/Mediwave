                ...
                <div className="row">
                    <div className="col-lg-6">
                        ...
                        <SectionTitle3
                                ...
                                content="Every project we deliver reflects our passion for innovation, precision, and measurable success."
                            ></SectionTitle3>
                    ...
                    <div className="col-lg-6">
                        <div className="image image-anime" data-aos="zoom-out" data-aos-duration="700" style={{ marginLeft: "200px", width: "450px", height: "auto" }} >
                            <img src="/assets/img/about/hero2-main-img1.png" alt=""  />
                        </div>
                    </div>
                </div>
            </div>
